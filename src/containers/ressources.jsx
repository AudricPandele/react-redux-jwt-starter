...
import { addRessource, getSpecialRessources } from '../actions';
  ...
  render() {
    return (
      <div className='row'>
        ...
        <div className='col'>
          Entiers
          <ul>{this.renderRessouces(this.props.ressourceList)}</ul>
        </div>
        <div className='col'>
          Contiennent "1"
          <ul>{this.renderRessouces(this.props.containsOneRessourceList)}</ul>
        </div>
        <div className='col'>
          Entier premiers
          <ul>{this.renderRessouces(this.props.primeRessourceList)}</ul>
        </div>
        <div className='col'>
          Entiers premiers contenants "1"
          <ul>{this.renderRessouces(this.props.specialNumber)}</ul>
        </div>
        {this.props.message}
      </div>
    );
